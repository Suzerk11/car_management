...
MarkBox.prototype = {
    ...
    createMarkBox: function(w, h) {
        ...
        if (flag) {
            ...
            document.getElementById('dialogTitle').innerText=this.title;
        } else {
            ...
            var html = "<div style='line-height:40px;height:40px;padding-left:10px;width:" + w + ";background:#76A6F5;'><span id='dialogTitle'>" + this.title + "</span><span id='closeId' style='float:right;color:red;line-height:40px;margin-right:10px;cursor:pointer'>关闭</span></div>";
